        ...
        <div>
            ...
            <div class="px-4 pt-5">
                ...
                <nav class="flex flex-col gap-1">
                    ...
                    {{-- Add a plant tab removed and placed with a button in the plant catalog page for better UX. --}}
            ...
            <div class="px-4 pt-6">
                ...
                {{-- Advisory / support tickets submitted by users --}}
                <a href="{{ route('admin.tickets') }}" class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm transition {{ request()->routeIs('admin.tickets*') ? 'font-semibold text-white bg-green-700' : 'text-gray-600 hover:bg-gray-100' }}">
